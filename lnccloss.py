...
# def orthogonal_loss(token_lists, num_tokens):
#     """_summary_

#     Args:
#         tokens (_type_): (B num_windows) N C
#     """
#     loss = 0
#     for token_list in token_lists:
#         for tokens in token_list:
#             tokens = torch.cat(tokens, dim=)
#             B_, N, C = tokens.shape
#             tokens = tokens.reshape(-1, num_tokens, C)
#             loss = loss + F.mse_loss(tokens.T() @ tokens, torch.eye(num_tokens))
#     print(loss)
#     return loss
